...
export const deactivateUser = createAction(types.DEACTIVATE_USER)
export const deactivateUserSuccess = createAction(types.DEACTIVATE_USER_SUCCESS)
export const confirmAndDeactivateUser = createAction(types.CONFIRM_AND_DEACTIVATE_USER)
